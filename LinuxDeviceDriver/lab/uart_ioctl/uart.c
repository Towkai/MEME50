...
// To do: define the IOCTL command: IOCTL_SET_BAUD
...
#endif
{
    ...
    printk("uart_ioctl(): IOCTL_SET_BAUD\n");

    switch(cmd)
    {
    case IOCTL_SET_BAUD:
         //To do: design by yourself
...
struct file_operations uart_fops = {
    ...
    .write=uart_write,
#if 0
    .ioctl=uart_ioctl,      /* ioctl */
#else
    .unlocked_ioctl=NULL,	// To do: register the ioctl call back function
#endif
    .open=uart_open,
    .release = uart_close
};
...
int __init init_module(void)
{
    ...
    // PORT_COM1, 2400, BITS_8 | PARITY_NONE | STOP_ONE
